...
function vendingmachine() {
    var shopItems = [
        ...
        { item_id: "water", id: 0, name: "Shop", information: "{}", slot: 3, amount: 50 }, 
        { item_id: "coffee", id: 0, name: "Shop", information: "{}", slot: 4, amount: 50 },
    ];
    return JSON.stringify(shopItems);
};
...
function recycle() {
    var shopItems = [
        ...
        { item_id: "binoculars", id: 0, name: "craft", information: "{}", slot: 8, amount: 50 }, 
...
function Blackmarket() {
    var shopItems = [
        ...
        { item_id: "1192676223", id: 0, name: "craft", information: "{}", slot: 2, amount: 5 },
