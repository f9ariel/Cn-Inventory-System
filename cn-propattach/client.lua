...
Citizen.CreateThread(function()
  exports["cn-binds"]:registerKeyMapping("", "Player", "Drop Prop", "+propAttachDrop", "-propAttachDrop")
...
RegisterNetEvent('cn-propattach:attach')
AddEventHandler('cn-propattach:attach', function(pPropItem, pTargetFunction)
